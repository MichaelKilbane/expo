...
- To begin using Native Firebase with Expo, you will start using the plugin `@react-native-firebase/app`. You can reference the [React Native Firebase docs](https://rnfirebase.io/#expo) for more details as needed.
